...
from qyunslation.exporter.srt.srt2html_exporter import Srt2HTMLExporterConfig, Srt2HTMLExporter
from qyunslation.exporter.srt.srt2srt_exporter import Srt2SrtExporter
from qyunslation.glossary.glossary import Glossary
from qyunslation.ir.document import Document
from qyunslation.translator.ai_translator.srt_translator import SrtTranslatorConfig, SrtTranslator
from qyunslation.workflow.base import Workflow, WorkflowConfig
from qyunslation.workflow.interfaces import HTMLExportable, SrtExportable
...
class SrtWorkflow(Workflow[SrtWorkflowConfig, Document, Document], HTMLExportable[Srt2HTMLExporterConfig],
    ...
    def __init__(self, config: SrtWorkflowConfig):
        ...
        self._translator: SrtTranslator | None = None  # 保存translator引用
        if config.logger:
