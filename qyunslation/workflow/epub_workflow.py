...
from qyunslation.exporter.epub.epub2epub_exporter import Epub2EpubExporter
from qyunslation.exporter.epub.epub2html_exporter import Epub2HTMLExporterConfig, Epub2HTMLExporter
from qyunslation.glossary.glossary import Glossary
from qyunslation.ir.document import Document
from qyunslation.translator.ai_translator.epub_translator import EpubTranslatorConfig, EpubTranslator
from qyunslation.workflow.base import Workflow, WorkflowConfig
from qyunslation.workflow.interfaces import HTMLExportable, EpubExportable
...
class EpubWorkflow(Workflow[EpubWorkflowConfig, Document, Document], HTMLExportable[Epub2HTMLExporterConfig],
    ...
    def __init__(self, config: EpubWorkflowConfig):
        ...
        self._translator: EpubTranslator | None = None  # 保存translator引用
        if config.logger:
