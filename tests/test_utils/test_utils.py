...
def test_get_httpx_proxies_no_proxy():
    ...
    with patch('qyunslation.utils.utils.getproxies', return_value={}):
...
def test_get_httpx_proxies_https_proxy_async():
    ...
    with patch('qyunslation.utils.utils.getproxies', return_value={'https': 'http://proxy:8080'}):
...
def test_get_httpx_proxies_http_proxy_async():
    ...
    with patch('qyunslation.utils.utils.getproxies', return_value={'http': 'http://proxy:8080'}):
        proxies = get_httpx_proxies(asyn=True)
